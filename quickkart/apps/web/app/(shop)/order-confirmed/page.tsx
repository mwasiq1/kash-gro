...
export default function OrderConfirmedPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#F4F6FA] gap-4">
        ...
        <p className="text-gray-500 font-bold">Verifying your order...</p>
      </div>
    );
  }
  ...
  if (!order) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#F4F6FA] p-6 text-center">
        ...
        <p className="text-gray-500 mb-8 max-w-sm">We couldn't retrieve the details for this order. It might still be processing.</p>
  ...
  return (
    <div className="min-h-screen bg-[#F4F6FA] pb-24">
      ...
      <div className="bg-white pt-16 pb-12 px-6 text-center border-b border-gray-100 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-500 font-medium mb-1">Order ID: <span className="font-bold text-[#1C1C1C]">{order.orderNumber}</span></p>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="pt-6 border-t border-gray-100 flex justify-between items-center">
              <div>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Total Paid via COD</p>
